 ...
 * topology on them.
 */
public class NetworkExampleHW2 {
    ...
    public static void main(String[] args) {
        ...
        Log.printLine("Starting NetworkExampleHW2...");
        ...
        try {
            ...
            NetworkTopology.buildNetworkTopology("topology_hw2.brite");
            ...
            Log.printLine("NetworkExampleHW2 finished!");
        }
        catch (Exception e) {
            e.printStackTrace();
